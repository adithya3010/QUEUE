...
export default function ModernLanding() {
    ...
    return (
        <div className="min-h-screen bg-[#060c21] text-white font-sans overflow-hidden selection:bg-primary-500/30 relative">
            ...
            <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-secondary-600/20 blur-[150px] rounded-full pointer-events-none" />
            <div className="absolute top-[40%] left-[30%] w-[30%] h-[20%] bg-light-blue-400/10 blur-[150px] rounded-[100%] pointer-events-none" />
            ...
            <nav className="relative z-50 flex items-center justify-between px-6 py-6 max-w-7xl mx-auto animate-fade-up opacity-0">
                <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded bg-gradient-to-br from-light-blue-400 to-primary-600 flex items-center justify-center shadow-lg shadow-primary-500/30">
                ...
                <div className="flex items-center gap-4">
                    <Link href="/login" className="text-sm font-bold bg-primary-600 bg-opacity-80 hover:bg-primary-500 text-white px-5 py-2 rounded-xl transition-all shadow-[0_0_15px_rgba(37,99,235,0.4)] border border-primary-400/50">
                        Get Started
                    </Link>
                </div>
            </nav>
            ...
            <main className="relative z-10 w-full pt-16 sm:pt-24 pb-20">
                ...
                <div className="max-w-4xl mx-auto text-center px-6 animate-fade-up opacity-0">
                    ...
                    <Link href="/signup" className="inline-block px-8 py-3 rounded-2xl bg-gradient-to-b from-primary-500 to-primary-700 hover:from-primary-400 hover:to-primary-600 border border-primary-400/50 text-white font-bold text-lg shadow-[0_10px_30px_rgba(37,99,235,0.5)] transition-all hover:-translate-y-1">
                        Get Started
                    </Link>
                </div>
                ...
                <div className="relative mt-24 mb-32 h-[500px] w-full max-w-7xl mx-auto overflow-visible px-4 animate-scale-in opacity-0">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center bottom-20">
                        <div className="w-[120%] h-[1px] bg-gradient-to-r from-transparent via-primary-400/50 to-transparent" />
                        <div className="absolute w-[80%] h-[300px] bg-primary-500/10 blur-[100px] rounded-[100%] pointer-events-none" />
                    </div>
                    ...
                    <div className="absolute left-[5%] top-[5%] md:left-[10%] md:top-[15%] w-[80%] md:w-[60%] h-[280px] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-3xl p-6 shadow-2xl flex md:flex-row flex-col gap-8 z-20">
                        ...
                        <div className="w-[240px] bg-white/10 border border-white/10 rounded-2xl p-4 shadow-inner">
                            ...
                            <div className="space-y-3">
                                ...
                                <button className="w-2/3 py-2 bg-primary-500 hover:bg-primary-400 rounded-lg text-xs font-bold mt-2 shadow-[0_5px_15px_rgba(59,130,246,0.4)] transition-colors">
                                    Add to Queue
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col justify-end pb-4 hidden md:flex">
                            <div className="mb-auto">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex items-center gap-2 bg-white/5 px-2 py-1 rounded"><div className="w-4 h-4 bg-red-500 rounded-sm rotate-45" /><span className="text-[10px] font-bold text-primary-100">MediCare</span></div>
                                    <div className="flex items-center gap-2 bg-white/5 px-2 py-1 rounded"><Activity className="w-4 h-4 text-light-blue-400" /><span className="text-[10px] font-bold text-primary-100">Nexa Health</span></div>
                                    <div className="flex items-center gap-2 bg-white/5 px-2 py-1 rounded"><Shield className="w-4 h-4 text-success-400" /><span className="text-[10px] font-bold text-primary-100">St.Anthony's</span></div>
                                </div>
                            </div>

                            {/* Abstract Illustration representation via CSS elements */}
                            <div className="flex items-end gap-3 opacity-60">
                                <div className="w-8 h-24 bg-gradient-to-t from-primary-500/20 to-transparent rounded-t-full relative">
                                    <div className="w-5 h-5 bg-primary-400 rounded-full absolute -top-5 left-1.5" />
                                </div>
                                <div className="w-32 h-1 bg-white/20 mb-2" />
                                <div className="w-12 h-16 bg-gradient-to-t from-secondary-500/20 to-transparent rounded-t-full relative">
                                    <div className="w-5 h-5 bg-secondary-400 rounded-full absolute -top-5 left-3.5" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="absolute z-30 right-[5%] md:right-[15%] -top-10 w-[260px] h-[520px] bg-[#11162d] border-[6px] border-gray-900 rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.8),0_0_20px_rgba(59,130,246,0.4)] flex flex-col py-6 px-4 hidden sm:flex hover:-translate-y-4 transition-transform duration-500">
                        ...
                        {/* Footer Indicator */}
                        <div className="mt-4 flex items-center justify-center gap-1.5 text-[10px] text-success-400 bg-success-400/10 py-1.5 rounded-full mx-8 border border-success-400/20">
                            <span className="w-1.5 h-1.5 rounded-full bg-success-400 animate-pulse" /> Updated Just Now
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-6 relative z-30 mb-20">
                    ...
                    {/* Live Queue Updates */}
                    <div className="bg-[#121833]/60 backdrop-blur-md border border-white/10 rounded-3xl p-6 overflow-hidden relative group hover:border-primary-500/40 transition-colors animate-fade-up opacity-0">
                        ...
                        <div className="w-full h-32 bg-gradient-to-br from-white/5 to-white/10 rounded-2xl border border-white/10 p-4 flex flex-col gap-3 relative shadow-inner">
                            <div className="w-full flex gap-3">
                                <div className="h-4 w-1/3 bg-primary-500/30 rounded-md border border-primary-400/20" />
                                <div className="h-4 w-1/4 bg-primary-400/20 rounded-md border border-white/5" />
                            </div>
                    ...
                    {/* ETA Calculation */}
                    <div className="bg-[#121833]/60 backdrop-blur-md border border-white/10 rounded-3xl p-6 overflow-hidden relative group hover:border-light-blue-500/40 transition-colors animate-fade-up opacity-0">
                        <div className="absolute inset-0 bg-gradient-to-br from-light-blue-600/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        ...
                        <div className="w-full h-32 flex justify-between gap-4 mt-auto">
                            ...
                            <div className="flex-1 bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center justify-between">
                                <div className="w-full">
                                    <p className="text-[10px] text-success-400 font-bold tracking-wider mb-2 flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-success-400 animate-pulse" /> Tracking Active
                                    </p>
                                    ...
                                    <div className="mt-3 w-full bg-white/10 h-1.5 rounded-full overflow-hidden">
                                        <div className="w-[60%] h-full bg-success-400 rounded-full" />
                                    </div>
                                </div>
                            </div>
                            {/* Right Mini Phone */}
                            <div className="w-24 bg-[#11162d] border-2 border-gray-700 rounded-t-xl rounded-b-sm translate-y-4 shadow-xl flex flex-col items-center p-2 relative overflow-hidden">
                                ...
                                <div className="w-full h-2 bg-white/10 mb-2 rounded-[2px]" />
                                <div className="w-full h-2 bg-success-400/20 mb-2 rounded-[2px] border border-success-400/30" />
                                <div className="w-full h-2 bg-white/10 mb-2 rounded-[2px]" />
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Patient Tracking */}
                    <div className="bg-[#1c183a]/60 backdrop-blur-md border border-secondary-500/20 rounded-3xl p-6 overflow-hidden relative group hover:border-secondary-500/50 transition-colors animate-fade-up opacity-0">
                        <div className="absolute inset-0 bg-gradient-to-br from-secondary-600/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        <h3 className="text-xl font-bold mb-1 text-white">Patient Tracking</h3>
                        <p className="text-sm text-secondary-200/50 mb-0">Check your status from anywhere.</p>
                        ...
                        <div className="absolute -bottom-8 -right-4 w-36 h-56 bg-[#0a0a14] rounded-[2rem] border-[4px] border-gray-800 shadow-2xl flex flex-col p-4 rotate-[-12deg] transition-transform group-hover:rotate-[-5deg]">
                            ...
                            <div className="mt-auto px-2 py-1.5 bg-primary-600 rounded-lg text-[10px] font-bold text-center border border-primary-400 shadow-[0_4px_10px_rgba(37,99,235,0.4)]">
                                Live Sync
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex-1 bg-[#0b1021] rounded-2xl border border-white/10 p-5 shadow-inner relative z-10 transition-transform hover:-translate-y-1">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                <div className="flex gap-2">
                                    <span className="px-2 py-1 bg-success-500 hover:bg-success-400 text-white rounded text-[10px] font-bold shadow-sm cursor-pointer">Available</span>
                            ...
                            <div className="mb-6 flex flex-col gap-1">
                                <div className="flex items-center justify-between bg-primary-900/20 p-3 rounded-lg border border-primary-500/20">
                                    <div className="flex items-center gap-2 text-sm text-primary-200">
                                        <span className="w-2 h-2 rounded-full bg-primary-500 shadow-[0_0_5px_rgba(59,130,246,0.8)]" />
                                        Next Patient: <span className="font-bold text-white">David K.</span>
                                    </div>
                                    <div className="flex items-center gap-1.5 text-xs text-success-400 font-bold bg-success-400/10 px-2 py-1 rounded">
                                        <span className="w-1.5 h-1.5 rounded-full bg-success-400 animate-pulse" /> 12 mins
                                    </div>
                                </div>
                            </div>
                                ...
                                {["Sarah L.", "John M."].map((name, i) => (
                                    <div key={i} className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                                        <div className="flex items-center gap-3 text-sm text-gray-300">
                                            <div className="w-6 h-6 rounded bg-primary-500/20 flex items-center justify-center text-primary-400 text-[10px] font-bold border border-primary-500/30">
                                                #{i + 2}
                                            </div>
                                            {name}
                                        </div>
                                ...
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between bg-white p-2.5 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-default">
                                        ...
                                        <div className="flex gap-1.5">
                                            ...
                                            <button className="px-2.5 py-1 bg-success-500 hover:bg-success-600 text-white rounded text-[10px] font-bold shadow-sm shadow-success-500/30 transition-colors">Complete</button>
                ...
                <div className="relative z-20">
                    <div className="flex flex-wrap justify-center gap-6 sm:gap-10 text-xs sm:text-sm font-bold text-light-blue-200/80 mb-12 animate-fade-up opacity-0">
                        <span className="flex items-center gap-2 bg-primary-900/30 px-3 py-1.5 rounded-full border border-primary-500/20"><CheckCircle2 className="w-4 h-4 text-success-400" /> Secure & Real-Time</span>
                        <span className="flex items-center gap-2 bg-primary-900/30 px-3 py-1.5 rounded-full border border-primary-500/20"><Lock className="w-4 h-4 text-primary-400" /> JWT Authentication</span>
                        <span className="flex items-center gap-2 bg-primary-900/30 px-3 py-1.5 rounded-full border border-primary-500/20"><Smartphone className="w-4 h-4 text-secondary-400" /> Mobile Friendly</span>
                    </div>
                    ...
                    <div className="text-center animate-fade-up opacity-0">
                        ...
                        <Link href="/signup" className="inline-block px-10 py-4 rounded-full bg-gradient-to-b from-primary-500 to-primary-700 border border-primary-400 hover:from-primary-400 hover:to-primary-600 text-white font-bold text-lg shadow-[0_10px_30px_rgba(37,99,235,0.4)] transition-transform hover:-translate-y-1">
                            Get Started
                        </Link>
                    </div>
                </div>
